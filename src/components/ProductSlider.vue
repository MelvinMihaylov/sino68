<template>
    <div class="py-28 px-2 bg-no-repeat bg-cover"
        style="background-image: url('/images/other_images/blur_image_background.jpg')">
        <div class="carousel relative container mx-auto md:border-solid md:border-2 md:border-white md:rounded-md"
            style="max-width: 1300px">
            <div class="carousel-inner relative overflow-hidden w-full md:rounded-md">
                <!--Slide 1-->
                ...
                <ol class="carousel-indicators">
                    <li class="inline-block mr-3">
                        <label for="carousel-1"
                            class="carousel-bullet cursor-pointer block text-4xl text-white hover:text-gray-900">•</label>
                    </li>
                    <li class="inline-block mr-3">
                        <label for="carousel-2"
                            class="carousel-bullet cursor-pointer block text-4xl text-white hover:text-gray-900">•</label>
