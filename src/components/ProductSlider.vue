        ...
        <div class="carousel-inner relative overflow-hidden w-full">
            ...
            <div class="carousel-item absolute opacity-0" style="height: 50vh">
                <div class="block h-full w-full mx-auto pt-6 md:pt-0 md:items-center bg-cover bg-right"
                    style="background-image: url('../../public/images/slider_images/pregrajdeniq-na-terasa.jpg');">
                </div>
            </div>
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-center" style="height: 50vh">
                <div class="block h-full w-full mx-auto pt-6 md:pt-0 md:items-center bg-cover bg-center"
                    style="background-image: url('../../public/images/slider_images/ograda.jpg');">
                </div>
            </div>
            ...
            <div class="carousel-item absolute opacity-0" style="height: 50vh">
                <div class="block h-full w-full mx-auto pt-6 md:pt-0 md:items-center bg-cover bg-top"
                    style="background-image: url('../../public/images/slider_images/klasicheska-ograda.jpg');">
                </div>
            </div>
            <label for="carousel-2"
