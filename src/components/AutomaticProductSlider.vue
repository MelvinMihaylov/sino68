      ...
      slides: [
        {
          ...
          stats: [
            { value: '1000+', label: 'реализирани проекта' },
        ...
        },
        {
          ...
          eyebrow: 'По размер и задача',
          title: 'Изработваме врати, огради и конструкции по реални размери',
          description:
            'Работим за домове, кооперации и бизнес обекти - от дворни врати и огради до навеси, рампи и сервизни решения.',
          tags: ['Врати', 'Огради', 'Конструкции'],
          stats: [
            { value: 'Врати', label: 'и портали' },
            { value: 'Огради', label: 'и парапети' },
            { value: 'Навеси', label: 'и козирки' }
          ]
        },
        {
          image: '/images/slider_images/metalni_ogradi4.jpg',
          eyebrow: 'Sino 68',
          title: 'Метални решения за дворове, входове, гаражи и работни обекти',
          description:
            'Поемаме проекта от точните размери до готовия монтаж, за да получите здраво, практично и добре завършено решение.',
          tags: ['По размер', 'Изработка', 'Монтаж'],
          stats: [
            { value: 'Размери', label: 'по заявка' },
            { value: 'Изработка', label: 'с детайл' },
            { value: 'Монтаж', label: 'на място' }
          ]
        }
      ],
